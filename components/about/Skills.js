...
const backend = [
  "Java", "Spring Boot, MVC, Data, Security, Reactive, Cloud", "JPA (Hibernate, MyBatis)", "Rest, SOAP", "Kafka", "Hazelcast", "Junit", "Cucumber"
]
...
const intro = "I have more than 10 years of experience" +
  "building rich web applications for clients" +
  "all over the world. Below is a quick overview" +
